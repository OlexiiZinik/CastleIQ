...
class ModelService(Service):
    ...
    def get_model(self, model:type["Model"]|None = None) -> type["Model"]:
        return self.model
    ...
    async def api_create_object(self, obj: type["BaseModel"]) -> type["Model"]:
    ...
    async def api_get_object(self, pk: int) -> type["Model"]:
    ...
    async def api_get_all(self) -> QuerySet["Model"]:
        objects = await self.get_model().all()
        return objects
    
    async def api_update_object(self, pk: int, new_obj: type["BaseModel"]) -> QuerySetSingle["Model"]:
